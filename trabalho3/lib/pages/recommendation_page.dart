...
class _RecommendationPageState extends State<RecommendationPage> {
  ...
  final List<Map<String, dynamic>> recommendations = const [
    {
      ...
      'details':
          'Roda jogos populares em 1080p com taxas de quadros confortáveis. Baixo custo.',
      'color': '#4CAF50',
      'os': 'Windows 10 Home',
      'storage_type': 'SSD',
      'ssd_count': 1,
    ...
    },
    {
      ...
      'details':
          'Excelente para jogos leves sem a necessidade de placa de vídeo dedicada. Baixíssimo custo inicial.',
      'color': '#4CAF50',
      'os': 'Windows 10 Home',
      'storage_type': 'SSD',
      'ssd_count': 1,
    ...
    },
    {
      ...
      'details':
          'Foco em performance estável em 1080p Ultra. Boa margem para multitarefa.',
      'color': '#FFC107',
      'os': 'Windows 11 Home',
      'storage_type': 'SSD',
      'ssd_count': 1,
    ...
    },
    {
      ...
      'details':
          'Plataforma moderna (AM5) com ótimo custo-benefício para games AAA.',
      'color': '#FFC107',
      'os': 'Windows 11 Home',
      'storage_type': 'SSD',
      'ssd_count': 1,
    ...
    },
    {
      ...
      'details':
          'Máxima performance para 1440p High Refresh Rate e 4K. Ideal para stream e criadores.',
      'color': '#D32F2F',
      'os': 'Windows 11 Pro',
    ...
    },
    {
      ...
      'details':
          'Alto número de núcleos e VRAM para resoluções extremas e multitarefas pesadas.',
      'color': '#D32F2F',
      'os': 'Windows 11 Pro',
      'storage_type': 'SSD e HD',
      'ssd_count': 2,
    ...
    },
    {
      ...
      'ram': '32 GB DDR5 6000MHz',
      'details':
          'Ótimo equilíbrio entre núcleos e VRAM para VMs, compilação e trabalho gráfico. Foco em estabilidade Linux.',
      'color': '#1976D2',
  ...
  void _saveRecommendation(Map<String, dynamic> rec) async {
    ...
    if (currentUserId == null) {
      _showMessage('Erro: Usuário não logado.');
      return;
    }
    ...
    final computerToSave = Computer(
      ...
      caseModel: 'Gabinete não definido',
    ...
    try {
      await _computerService.insertComputer(computerToSave);
      _showMessage(
          'Build "${rec['title']}" salvo como RASCUNHO (Falta Gabinete)!');
    } catch (e) {
      _showMessage('Erro ao salvar o build: ${e.toString()}');
    }
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: recommendations.map((rec) {
          final levelColor = HexColor(rec['color']!);
          return Card(
            elevation: 8,
                ...
                children: [
                  Text(
                    ...
                    style: theme.textTheme.headlineSmall
                        ?.copyWith(color: levelColor, fontWeight: FontWeight.w900, fontSize: 22),
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildDetailRow(context, 'Armazenamento',
                            '${rec['ssd_count']}x SSD / ${rec['hd_count']}x HD'),
                      ],
                    ),
                  ),
